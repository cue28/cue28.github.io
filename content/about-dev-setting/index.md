...
주니어 개발자(나)에게 '입사하고 힘들었던 경험이 있나요?' 라고 물으면 반은 '개발 환경 세팅이요!' 할 것 같다. 개발 공부를 하면서 노트북을 바꿔 총 3번 환경 세팅을 한 경험이 있다. 그때마다 느낀점은 블로그를 잘 찾아야한다. 컴퓨터마다 사양이 다르고 M1칩이 나오면서 세팅 방법이 다양해졌다. 이번에 블로깅할 세팅 방법은 Mac Pro Inter에 적용한 방법이다.
